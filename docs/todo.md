...
- [x] 22. 修改 `App.tsx` 添加新视图状态
- [x] 23. 在主页添加"工作流编辑器"入口卡片
- [x] 24. 实现视图切换逻辑
- [x] 25. 保留单模块入口（向后兼容）
...
- [x] 26. 添加节点启用/禁用开关
- [x] 27. 添加工作流导入/导出（JSON）
- [x] 28. 实现导出视频功能（Remotion CLI）
- [x] 29. 优化大文件处理（IndexedDB 替代 localStorage）
- [ ] 30. 添加节点预览缩略图

**Phase 6 导出功能已完成** ✅
- ✅ 安装 Remotion CLI 和 Bundler
- ✅ 创建渲染入口文件
- ✅ 创建导出脚本
- ✅ 实现导出对话框 UI
- ✅ 支持视频文件导出
